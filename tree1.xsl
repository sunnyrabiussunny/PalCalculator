...
<span class="fname"><xsl:attribute name="title"><xsl:value-of select="fname" /><xsl:text> </xsl:text> <xsl:value-of select="lname" /></xsl:attribute>
				...
				</span></span><div class="infoBoxOff">
